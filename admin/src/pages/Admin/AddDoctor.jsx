                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="General physician">Criminal Lawyer</option>
                                <option value="Gynecologist">Family Lawyer</option>
                                <option value="Dermatologist">Corporate Lawyer</option>
                                <option value="Pediatricians">IP Lawyer</option>
                                <option value="Neurologist">Employment Lawyer</option>
